...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase001(self):
        ...
        try:
            ...
            GetReturn=NewLoadList(self,"专线","廊坊转运场","京E64933","刘得松","","精准卡航",self.GetReturnValue(9,9))
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(10, 8, "True!")
            else:
                self.WriteRes(10, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(10,9,GetReturn)
