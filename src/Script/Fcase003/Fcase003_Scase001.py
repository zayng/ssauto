...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase003(self):
        ...
        try:
            ...
            GetReturn=AddEir(self,"短配交接单","上海转运场","沪B94908","刘洋洋","999999926","2013-06-14 09:37:47")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(29, 8, "True!")
            else:
                self.WriteRes(29, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(29,9,GetReturn)
