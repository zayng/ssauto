...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase004(self):
        ...
        try:
            ...
            ConfirmSend(self,self.GetReturnValue(54,9),"2013-05-20 00:00:00","2013-06-14 23:59:59")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(57, 8, "True!")
            else:
                self.WriteRes(57, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(57,9,GetReturn)
