...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase005(self):
        ...
        try:
            ...
            GetReturn=AddEir(self,"短配交接单","上海转运场","沪B94908","刘洋洋","999999927","2013-06-14 09:37:47")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(63, 8, "True!")
            else:
                self.WriteRes(63, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(63,9,GetReturn)
