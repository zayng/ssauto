...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase002(self):
        ...
        try:
            ...
            Navigation(self,"外发管理-空运管理-查询航空正单")
            NewAirlinesBill(self,"东方航空公司","11124348","合大票","成都市八方运务有限公司","MU8888","23","819202032")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(27, 8, "True!")
            else:
                self.WriteRes(27, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(27,9,GetReturn)
