...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase004(self):
        ...
        try:
            ...
            GetReturn=NewLoadList(self,"整车","上海闵行区浦江镇营业","渝BC8202","李琦","100","精准卡航",self.GetReturnValue(54,9))
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(55, 8, "True!")
            else:
                self.WriteRes(55, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(55,9,GetReturn)
