...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase001(self):
        ...
        try:
            ...
            ConfirmSend(self,self.GetReturnValue(1,9),"2013-05-20 00:00:00","2013-06-14 23:59:59")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(3, 8, "True!")
            else:
                self.WriteRes(3, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(3,9,GetReturn)
