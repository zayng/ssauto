...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase004(self):
        ...
        try:
            ...
            Login(self,"http://192.168.10.50/stl-web/login/index.action","046788","qqqqqq","上海青浦区工业园营业部")
            Navigation(self,"约车管理-外请车约车")
            GetReturn=AskOutCarAppoint(self,"整车约车","到营业部","10","上海车队","上海闵行区浦江镇营业部","上海","1","木","3","4","天天","18721212121")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(46, 8, "True!")
            else:
                self.WriteRes(46, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(46,9,GetReturn)
