...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase004(self):
        ...
        try:
            ...
            GetReturn=AddEir(self,"集配交接单","上海闵行区浦江镇营业","渝BC8202","李琦","999999298","2013-06-14 09:37:47")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(54, 8, "True!")
            else:
                self.WriteRes(54, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(54,9,GetReturn)
