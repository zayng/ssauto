...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase005(self):
        ...
        try:
            ...
            Navigation(self,"签收管理-空运偏线签收")
            AirFarOffSign(self,"999999927","汽运偏线","天天","身份证","110101198812012773")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(72, 8, "True!")
            else:
                self.WriteRes(72, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(72,9,GetReturn)
