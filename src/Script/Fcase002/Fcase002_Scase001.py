...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase002(self):
        ...
        try:
            ...
            GetReturn=AddEir(self,"短配交接单","上海空运总调","沪B94908","舒继开","819202032","2013-06-14 09:37:47")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(20, 8, "True!")
            else:
                self.WriteRes(20, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(20,9,GetReturn)
