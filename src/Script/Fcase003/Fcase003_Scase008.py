...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase003(self):
        ...
        try:
            ...
            GetReturn=AddEir(self,"短配交接单","上海虹口营业部","沪B94908","刘洋洋","999999926","2013-06-14 09:37:47")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(36, 8, "True!")
            else:
                self.WriteRes(36, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(36,9,GetReturn)
