...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase005(self):
        ...
        try:
            ...
            ConfirmArrive(self,self.GetReturnValue(63,9),"2013-05-20 00:00:00","2013-06-14 23:59:59")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(66, 8, "True!")
            else:
                self.WriteRes(66, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(66,9,GetReturn)
