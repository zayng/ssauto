...
class Test(unittest.TestCase):
    ...
    def testFoss_Fcase001(self):
        ...
        try:
            ...
            NewLongDispatchPlan(self,"2013-06-14","上海转运场","廊坊转运场")
            MakeLongDispatchPlanInCar(self,"北京车队城区内环接送货组","京E64933","2013-06-14 09:09:09","2013-06-14 09:09:09","2013-06-14 09:09:09","北京车队城区内环接送货组","刘得松")
        except:
            self.boolean=False
            raise RuntimeError
        finally:
            if self.boolean==True:
                self.WriteRes(8, 8, "True!")
            else:
                self.WriteRes(8, 8, 'FALSE!')
            if GetReturn !="":
                self.WriteRes(8,9,GetReturn)
